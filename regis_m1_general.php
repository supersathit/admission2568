<?php
    ...
    $sql = "SELECT code_id FROM regis_m1_general WHERE code_id = $code_id";
                        ...
                        <div class="row p-3">
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="ปกติ" id="invalidCheck1" name="plan" onclick="if(this.checked){myFunction1()}" required>
                                ...
                                <div class="ps-5 mmm" id="mmm">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="ด้านทัศนศิลป์" id="invalidCheck3" name="plan1">
                                        <label class="form-check-label" for="invalidCheck3">ด้านทัศนศิลป์</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="ด้านดนตรี" id="invalidCheck4" name="plan1">
                                        <label class="form-check-label" for="invalidCheck4">ด้านดนตรี</label>
                                    </div>
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" value="ด้านนาฏศิลป์" id="invalidCheck5" name="plan1">
                                        <label class="form-check-label" for="invalidCheck5">ด้านนาฏศิลป์</label>
                                    </div>
                                    <div class="col-12 mb-3">
                            ...
                            <div class="col-12 mb-3 col-lg-6">
                                ...
                                <input type="file" name="grade_file1" id="" class="form-control" accept="image/*" required>
                            </div>
                            <div class="col-12 mb-3 col-lg-6">
                                <label for="validationCustom01" class="form-label">เอกสารแสดงผลการเรียนหน้า2 (ถ้ามี)</label>
                                <input type="file" name="grade_file2" id="" class="form-control" accept="image/*">
                            </div>
                            <div class="col-12 mb-3 col-lg-6">
                                <label for="validationCustom01" class="form-label">สำเนาทะเบียนบ้านนักเรียน</label>
                                <input type="file" name="house_regis" id="" class="form-control" accept="image/*" required>
                            </div>
