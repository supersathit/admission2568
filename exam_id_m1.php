            ...
            <div class="col-12 col-lg-8">
                <div class="card shadow rounded-4 p-3 mb-4">
                    ...
                    <div class="fw-bold text-center">
                        ข้อมูลประจำตัวผู้เข้าสอบศึกษาต่อชั้นมัธยมศึกษาปีที่ 1 <br>
                    ...
                    <div class="mb-3">
                        <p>
                            ...
                            <div class="mt-3"><strong>แผนการเรียนที่เลือก</strong></div>
                            <div class="ps-3 mb-3">
                            ...
                            <div class="p-3 rounded-3 bg-warning">
                                <table class="table table-bordered table-hover table-striped table-light">
                                    <tbody class="text-center fw-bold">
                                        <?php  
                                            $value = mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM regis_m1,list_exam_m1 WHERE regis_m1.code_id = list_exam_m1.code_id AND regis_m1.code_id = '$code_id'"));
                    ...
                    <div class="mb-3">
                        <img src="img/table_exam_m1.jpg" width="100%">
                    </div>
