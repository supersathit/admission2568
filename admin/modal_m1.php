...
<div class="modal fade" id="ModalEdit<?=$value['code_id']?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalEdit<?=$value['code_id']?>" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <form action="php_edit_m1_general.php" method="post">
        <div class="modal-body">
          <strong>1. ประวัติส่วนตัว</strong>
            <div class="row p-3">
                ...
                <div class="col-12 mb-3 col-lg-4">
                    ...
                    <select name="class1" id="validationCustom01" class="form-select" >
                        <option value="<?=$value['class1']?>" selected><?=$value['class1']?></option>
                        <option value="esmat">E-SMAT</option>
                        <option value="สสวท">สสวท.</option>
                ...
                <div class="col-12 mb-3 col-lg-4">
                    ...
                    <select name="class2" id="validationCustom01" class="form-select" >
                        <option value="<?=$value['class2']?>" selected><?=$value['class2']?></option>
                        <option value="esmat">E-SMAT</option>
                        <option value="สสวท">สสวท.</option>
                        <option value="ep">EP</option>
                    </select>
                ...
                <div class="col-12 mb-3 col-lg-4">
                    ...
                    <select name="class3" id="validationCustom01" class="form-select" >
                        <option value="<?=$value['class3']?>" selected><?=$value['class3']?></option>
                        <option value="esmat">E-SMAT</option>
                        <option value="สสวท">สสวท.</option>
                        <option value="ep">EP</option>
                    </select>
